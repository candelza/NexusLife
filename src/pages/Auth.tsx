...
const Auth = () => {
  ...
  const handleGoogleAuth = async () => {
    // If in production and Google OAuth is not configured, show message
    if (isProduction) {
      toast({
      ...
      <div className="w-full max-w-md">
        <Card className="bg-card/60 backdrop-blur-sm border-border/50 shadow-peaceful">
          ...
          <CardContent>
            ...
            {/* Google Login Button - Conditionally Disabled */}
            {!isProduction && (
              <div className="mb-6">
                <Button
                ...
                >
                  {isGoogleLoading ? (
                    ...
                    <>
                      ...
                      เข้าสู่ระบบด้วย Google (เฉพาะ Local)
                    </>
                  )}
                </Button>
              ...
              <div className="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-xs text-blue-800">
                    ...
                    <p>Google OAuth ถูกปิดใช้งานใน production เพื่อความปลอดภัย</p>
                  </div>
                </div>
              </div>
            )}
